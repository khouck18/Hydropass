      ...
      <CardContent>
        <Grid container sx={{ px: 2 }}>
          ...
          <Grid item xs={7} sm={7} md={7} lg={7} sx={{ mb: 3 }}>
            <Grid container justifyContent="flex-end">
              <Typography variant="h5">
                <StarIcon color="lightSalmon" sx={{ fontSize: 35, mb: 1 }} />{" "}
                {listingInformation.rating} | 20 Reviews
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        <Box sx={{ width: "100%", p: 2 }}>
          <DateRangePicker
            ...
            onChange={(e) =>
              e[1] !== null ? updateSelectedDates(e[0].$d, e[1].$d) : null
            }
          />
          <TextField
            id="NumberOfGuests"
          ...
          <Grid container sx={{ pt: 4, pb: 2 }}>
            ...
            <Box
              variant="div"
              sx={{ borderBottom: "1px solid gray", my: 2, width: "100%" }}
            />
            <Grid item xs={8} sm={8} md={8} lg={8}>
